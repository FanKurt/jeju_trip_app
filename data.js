...
window.TRIP = {
  ...
  notices: {
    pre: [
      ...
      { t: '電壓轉接頭',             d: '韓國 220V,2 孔圓形插座,需 C 型轉接頭' },
      { t: '時差',                   d: '韓國比台灣快 1 小時(韓國 12:00 = 台灣 11:00)' },
      { t: '常備藥品',               d: '感冒藥、腸胃藥、暈車藥(漢拏山山路)' },
    ],
    pack: [
      { t: '護照 + K-ETA 紙本備份',           done: false },
      { t: '輕便外套(5月日均 16–22°C)',       done: false },
    ...
    weather: { range: '16 – 22°C', rain: '偶陣雨', tip: '洋蔥式穿搭,準備薄外套' },
    korea: {
      temp:     { range: '16°C ~ 22°C', note: '濟州島 5 月平均氣溫,因全球氣候異動大,建議出發前再次上網查詢' },
      timezone: { diff: '韓國比台灣快 1 小時', example: '韓國 12:00 = 台灣 11:00' },
      voltage:  { spec: '220V / 2 孔圓形插座', note: '需準備 C 型轉接頭' },
    },
    baggage: {
      checked: {
        weight: '每人免費 20 公斤',
    ...
    refund: {
      ...
      where:     '市區退稅處 / 自助退稅機 / 機場退稅機',
      docs:      ['護照', '購物退稅單', '退稅商品(未拆封)'],
      eligible: [
        '入境滯留期間未滿 6 個月的外國人',
        '海外居住 2 年以上或持有海外永住權,並在韓國滯留 3 個月以內的韓國僑胞',
      ],
      conditions: [
        '須在退稅商店進行購物',
        '單筆消費滿 ₩15,000(依退稅方式上限有所不同)',
        '消費日後 3 個月內出境',
        '攜帶護照;若以信用卡消費,需使用持卡人本人的護照辦理',
      ],
      methods: [
        { title: '現場退稅', desc: '結帳時出示護照,即可支付免稅後金額。' },
        { title: '市區退稅', desc: '至市區退稅處或自助退稅機,插入信用卡並掃描護照可立即拿到退稅金。離境前須再至機場自助退稅機掃描退稅單;單筆退稅金額超過 ₩75,000 須將物品帶至海關金額檢驗,未完成手續會從信用卡扣回並產生罰金。' },
        { title: '機場退稅', desc: '購物時索取退稅單,於退稅機台掃描護照與退稅單;高額退稅者須向海關出示商品蓋章後再託運,並於退稅櫃檯或機台領現金(信用卡退稅免此步驟)。' },
      ],
      notice: '出發前建議再次查詢官方網站,確認最新退稅規定',
    },
    customs: {
      banned: [
        '新鮮蔬果',
      ...
      warn: '攜帶未申報將處以高額罰鍰',
      pork: '一旦違規攜帶疫區豬肉製品入境,首次可開罰新臺幣 20 萬元罰鍰,再次違規最高將處以 100 萬元',
      tip:  '不確定時,請主動到檢疫檯詢問,避免受罰(最終須以中華民國防檢局最新公告為準)',
    },
  },
  contacts: [
    { name: '金憶如', ext: '15690' },
