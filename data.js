...
window.TRIP = {
  ...
  notices: {
    pre: [
      ...
      { t: '韓國 K-ETA 免申請',      d: '台灣護照旅客享免 K-ETA 待遇,出發前無需付費申請即可入境觀光' },
      { t: '常備藥品',               d: '感冒藥、腸胃藥、暈車藥(漢拏山山路)' },
    ],
    pack: [
      { t: '護照(台灣旅客免 K-ETA)',          done: false },
      { t: '輕便外套(早晚較涼)',              done: false },
    ...
    weather: { range: '16 – 22°C', rain: '偶陣雨' },
    korea: {
      temp:     { range: '16°C ~ 22°C', note: '濟州島 5 月平均氣溫,偶陣雨;洋蔥式穿搭、備薄外套。因全球氣候異動大,建議出發前再次上網查詢' },
